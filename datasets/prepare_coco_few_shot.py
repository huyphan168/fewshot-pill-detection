...
server_path = "/mnt/disk1/huyvinuni/"
...
def generate_seeds(args):
    data_path = os.path.join(server_path,'datasets/cocosplit/datasplit/trainvalno5k.json')
    ...
    #anno is a dictionary with the keys is id of the class, values is a list of boxes belonging to that class 
...
def get_save_path_seeds(path, cls, shots, seed):
    ...
    save_dir = os.path.join(server_path, 'datasets', 'cocosplit', 'seed' + str(seed))
