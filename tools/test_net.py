...
"""
import sys
sys.path.insert(1,"/home/aiotlab/projects/huyvinuni/RFC/few-shot-object-detection")
...
class Trainer(DefaultTrainer):
    ...
    def build_evaluator(cls, cfg, dataset_name, output_folder=None):
        ...
        if output_folder is None:
            output_folder = os.path.join(cfg.OUTPUT_DIR, "infer")
        ...
        if evaluator_type == "emed":
            evaluator_list.append(
                EMEDEvaluator(dataset_name, cfg, True, output_folder)
            )
