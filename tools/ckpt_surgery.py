...
if __name__ == '__main__':
    ...
    if args.coco:
        ...
        name2id = pkl.load(open("/home/huyen/projects/huypn/FewShotDetection/data/vaipe/name2id.pkl","rb"))
        base_classes = pkl.load(open("/home/huyen/projects/huypn/FewShotDetection/data/vaipe/base_names.pkl","rb"))
        novel_classes = pkl.load(open("/home/huyen/projects/huypn/FewShotDetection/data/vaipe/few_shot_names.pkl","rb"))
