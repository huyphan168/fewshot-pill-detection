...
def load_coco_json(json_file, image_root, metadata, dataset_name):
    ...
    if is_shots:
        ...
        split_dir = "/mnt/disk1/huyvinuni/datasets/cocosplit/"
        ...
        json_file = os.path.join("/mnt/disk1/huyvinuni/datasets/",json_file)
        with contextlib.redirect_stdout(io.StringIO()):
            coco_api = COCO(json_file)
...
def register_meta_coco(name, metadata, imgdir, annofile):
    ...
    MetadataCatalog.get(name).set(
        ...
        image_root=imgdir,
        evaluator_type="coco",
        dirname="/mnt/disk1/huyvinuni/datasets/coco",
        **metadata,
    )