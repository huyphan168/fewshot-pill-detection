...
__all__ = ["GeometricRCNN"]


@META_ARCH_REGISTRY.register()
class GeometricRCNN(nn.Module):
    """
    ...
    def __init__(self, cfg):
        ...
        if cfg.MODEL.ROI_HEADS.FREEZE_GEOMETRIC:
            for conv in self.roi_heads.box_head.convs_edge:
                for p in conv.parameters():
                    p.requires_grad = False
            for conv in self.roi_heads.box_head.convs_texture:
                for p in conv.parameters():
                    p.requires_grad = False
            print("froze roi_box_head geometric parameters")
