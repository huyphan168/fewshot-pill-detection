...
from fsdet.layers.gdl import AffineLayer, decouple_layer
import logging
...
class GeneralizedDecoupledRCNN(nn.Module):
    ...
    def _forward_once_(self, batched_inputs, gt_instances=None):
        ...
        if self.cfg.MODEL.PROPOSAL_GENERATOR.ENABLE_DECOUPLE:
            scale = self.cfg.MODEL.PROPOSAL_GENERATOR.BACKWARD_SCALE
